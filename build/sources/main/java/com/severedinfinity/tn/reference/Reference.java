 ...
 *
 * Reference.java was created 15/2/2015 and last updated 2/15/15 3:43 PM
 */
...
//  public static final String LOWERCASE_MOD_ID = MOD_ID.toLowerCase();
  ...
  //FIXME can't remember what @VERSION@ does
  public static final String VERSION = "@VERSION@";
  public static final String ACCEPTED_VERSIONS = "[1.12.2]";
  public static final String SERVER_PROXY_CLASS = "com.severedinfinity.tn.proxy.ServerProxy";
  public static final String CLIENT_PROXY_CLASS = "com.severedinfinity.tn.proxy.ClientProxy";
  public static final String GUI_FACTORY_CLASS = "com.severedinfinity.tn.client.gui.GuiFactory";
}
